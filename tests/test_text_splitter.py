...
def test_text_splitter_initialization():
    ...
    splitter = TextSplitter(chunk_size=500, chunk_overlap=50, strategy="token")
...
def test_min_chunk_size_filtering():
    ...
    splitter = TextSplitter(chunk_size=50, chunk_overlap=10, min_chunk_size=20)
    chunks = splitter.split_text(text)
...
def test_different_strategies(sample_text, strategy):
    ...
    splitter = TextSplitter(chunk_size=500, chunk_overlap=50, strategy=strategy)
    chunks = splitter.split_text(sample_text)
...
def test_token_strategy():
    ...
    splitter = TextSplitter(chunk_size=100, chunk_overlap=10, strategy="token")  # tokens
    chunks = splitter.split_text(text)
...
def test_character_strategy():
    ...
    splitter = TextSplitter(chunk_size=200, chunk_overlap=20, strategy="character")
    chunks = splitter.split_text(text)
...
def test_chunk_char_count():
    ...
    chunk = Chunk(text="Test content", metadata={}, chunk_id="test_1")
...
def test_chunk_word_count():
    ...
    chunk = Chunk(text="One two three four", metadata={}, chunk_id="test_1")
...
def test_chunk_to_dict():
    ...
    chunk = Chunk(text="Test", metadata={"key": "value"}, chunk_id="test_1")
...
def test_chunk_analyzer_basic(sample_text):
    ...
    from src.document_processor.text_splitter import ChunkAnalyzer, TextSplitter
